...
const awsConfig = {
  accessKeyId: "AKIA6D3LVYSF4SLDBVEU",
  secretAccessKey: "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",
  region: "us-east-1",
};
...
export const checkEnrollment = async (req, res) => {
  ...
  //if courseId found in user courses array
  let ids = [];
  user.courses.forEach((course) => {
    ids.push(course.toString());
  });
  res.json({
